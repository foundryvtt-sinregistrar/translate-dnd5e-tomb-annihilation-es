...
### appendix-d-yellow-musk — Trepadora y zombi amarillos almizclados

- Revisados 56 campos de ambas copias de los actores y su página.
  Referencias físicas 235 y 236. Incluye huéspedes humanoides, maduración,
  variante Pequeña y destrucción del bulbo antes de la transformación.
- Corregidos «30 metros» del PDF a los 30 pies del exportado y el corchete
  suelto en «charmed]». Conservadas las 24 horas hasta la reanimación.
- El exportado añade daño necrótico entre los tipos que impiden la regeneración
...
### appendix-d-zitembe — Abuelo Zitembe

- Revisados 70 campos: página y ambas copias completas. Referencia física
  22 para la biografía; rasgos y conjuros contrastados con el exportado inglés.
- Conservadas las condiciones para obtener su ayuda y las visiones de Omu.
  Revisados la progresión de Eminencia Divina y Arma espiritual, las
  exclusiones de Guardianes espirituales y las condiciones de Santuario.
...
### appendix-d-syndra — Syndra Silvane

- Revisados 164 campos: página de presentación y ambas copias del actor.
  Referencias físicas 6 y 9; perfil, conjuros y efectos contra el inglés.
- Comprobados el deterioro diario de la maldición, las imágenes ilusorias,
  las resistencias opuestas del Escudo de fuego y el bloqueo por nivel original
  del conjuro en Globo de invulnerabilidad.
- La lista exportada tiene encabezados desplazados: nivel 1 «a voluntad»,
  nivel 2 con cuatro espacios y trucos con tres espacios. Los datos de la ficha
  contienen cuatro espacios de nivel 1 y tres de nivel 2. Se registra la
  discrepancia para reparar la descripción; esta pasada conserva el original.

### appendix-d-valindra — Valindra Shadowmantle

- Revisados 210 campos: página de presentación y ambas copias del actor.
  Referencias físicas 50–51; acciones, conjuros, efectos y mensajes de chat
  contra el exportado inglés.
- Conservadas la excepción de los muertos vivientes en Perturbar vida, la
  sustitución de conjuros al prepararlos, las condiciones de Ilusión Mágica y
  la prohibición de acciones en guarida en el Corazón de Ubtao. Los textos
  genéricos de guarida siguen presentes en la ficha, como en el exportado.
- Mirada aterradora enlaza erróneamente `grappled` bajo la etiqueta inglesa
...
### additional-cats-boars — Felinos y jabalíes

- Revisados 156 campos de tigre, pantera, león, jabalí y jabalí gigante en
  ambas copias, contra el exportado inglés. Sin biografías narrativas nuevas.
- Corregida la mención accidental a «panther» en Abalanzarse del tigre: el
  sujeto es el propio tigre. Conservados los enlaces y las tiradas originales.
- Comprobados los requisitos de carrera y ataque en el mismo turno, el ataque
  adicional contra objetivos derribados, el salto del león y los umbrales de
...
### additional-generic-casters — Lanzadores genéricos

- Revisados 300 campos de acólito, sacerdote, mago y Mago Rojo en ambas copias.
  Listas contrastadas con el exportado inglés y con los identificadores y
  nombres de los conjuros incluidos en cada actor.
- Reutilizadas las descripciones de conjuros idénticas a segmentos revisados,
  comprobando referencias, cantidades y HTML. Ajustados los textos de chat al
  género del perfil genérico y conservados sus espacios, niveles y CD.
...
### additional-modrons — Monodrón, cuadrón y pentadrón

- Revisadas las tres fichas y sus copias de Adventure: 84 registros contrastados
  con el exportado inglés. Comprobados los dos ataques de puñetazo o cuatro de
  arco corto del cuadrón, los cinco ataques de brazo del pentadrón y la duración
...
### additional-green-faerie — Dragón feérico verde

- Revisados 38 registros en ambas copias, contrastados con el exportado inglés.
  Comprobados los resultados 1–4 y 5–6 del aliento eufórico, la prohibición de
  reacciones y la concentración necesaria para su invisibilidad.
- La lista de conjuros del original solo incluye sugestión aunque su texto
  menciona conjuros adicionales por edad y color; conservada esa lista sin
  inventar conjuros ausentes. Pendiente de comprobar el perfil funcional.

### additional-drow-mage — Mago drow

- Revisados 90 registros en ambas copias, incluidos los textos de los conjuros,
  contra el exportado inglés. Corregido el género del mensaje de lanzamiento,
  que heredaba «maga» de otro personaje.
- El original usa la ficha de mago genérico: subtipo «cualquier raza», cuatro
  idiomas cualesquiera y sin rasgos drow en sus objetos. Se conservan estos
  datos y se registra la discrepancia para la revisión funcional del perfil.

### additional-guardian-naga — Naga guardiana

- Revisados 92 registros en ambas copias, incluidos sus conjuros, contra el
  exportado inglés. Comprobados el rejuvenecimiento, los componentes verbales,
  los efectos de destierro según el plano de origen y el límite diario de geas.
...
- Revisados 102 registros en ambas copias contra el exportado inglés,
  incluidos los conjuros. Comprobadas las excepciones al cambiar de forma,
  los componentes verbales y el veneno que permite despertar al objetivo.
...
### gems-* — Gemas y metales preciosos

- Revisados 39 objetos (76 campos) contra el exportado inglés: gemas,
  brazaletes, cadenas, lingotes y polvo de oro, incluidas sus procedencias.
- Normalizados los nombres de criaturas y localizaciones con la terminología
